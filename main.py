...
from dropblock import resnet56
...
parser.add_argument('--ckpt_save_dir', default='./save')
parser.add_argument('--checkpoint', default='./save/latest_checkpoint.pth.tar')
# Hyperparameters
...
parser.add_argument('--dropblock', default=True)
